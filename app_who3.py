...
def main():
    ...
    # Remove these lines entirely, or use shapes instead of add_vline
    # Example using add_shape to avoid date arithmetic issues:
    fig_global.add_shape(
        type="line",
        x0=_dt.datetime(2021, 3, 31),
        x1=_dt.datetime(2021, 3, 31),
        y0=0,
        y1=1,
        xref='x',
        yref='paper',
    ...
    fig_global.add_shape(
        type="line",
        x0=_dt.datetime(2022, 1, 31),
        x1=_dt.datetime(2022, 1, 31),
        y0=0,
        y1=1,
        xref='x',
        yref='paper',
